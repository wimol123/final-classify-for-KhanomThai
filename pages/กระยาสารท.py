...
kanom_img_path = os.getenv("COMPONENT_krayasrad_PATH1")
component_1_path = os.getenv("COMPONENT_krayasrad_PATH2")
component_2_path = os.getenv("COMPONENT_krayasrad_PATH3")
