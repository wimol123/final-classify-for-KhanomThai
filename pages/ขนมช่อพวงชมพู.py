...
kanom_img_path = os.getenv("COMPONENT_84_PATH1")
...
ขนมช่อพวงชมพู เป็นขนมไทยโบราณที่ไม่มีหลักฐานแน่ชัดว่า มีที่มาจากที่ใด แต่สันนิษฐานว่าน่าจะได้รับอิทธิพลมาจาก ขนมช่อม่วง ของชาววัง โดยดัดแปลงสูตรมาใช้สีชมพูจาก หัวบีทรูท หรือ หัวผักกาดแดง แทนดอกอัญชัน และเปลี่ยนไส้เป็น เนื้อกุ้งสับ ผสมกับ แครอท

ขนมช่อพวงชมพูมีเอกลักษณ์ที่โดดเด่นคือ สีสันที่สดใส รูปร่างที่สวยงาม คล้ายดอกพวงชมพู และรสชาติที่อร่อยหวานมัน เค็ม กลมกล่อม
