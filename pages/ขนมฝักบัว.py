...
kanom_img_path = os.getenv("COMPONENT_160_PATH1")
# component_1_path = os.getenv("COMPONENT_109_PATH2")
# component_2_path = os.getenv("COMPONENT_109_PATH3")

# Set page configuration
st.set_page_config(
    page_title="ขนมฝักบัว: ขนมไทยโบราณ รูปร่างน่ารัก หอมหวานมัน ทานเล่นหรือทานคู่กับอาหารคาว",
    page_icon="🌸",
    layout="wide",
...
# Display title
st.title("ขนมฝักบัว: ขนมไทยโบราณ รูปร่างน่ารัก หอมหวานมัน ทานเล่นหรือทานคู่กับอาหารคาว")
